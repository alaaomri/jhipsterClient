  ...
  return (
    <div>
      <h2 id="notification-heading">
        <Translate contentKey="jhipsterClientApp.notification.home.title">Notifications</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterClientApp.notification.home.createLabel">Create new Notification</Translate>
        </Link>
      </h2>
        ...
        {notificationList && notificationList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('date')}>
                  <Translate contentKey="jhipsterClientApp.notification.date">Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('details')}>
                  <Translate contentKey="jhipsterClientApp.notification.details">Details</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterClientApp.notification.home.notFound">No Notifications found</Translate>
            </div>
          )
        )}
      </div>
