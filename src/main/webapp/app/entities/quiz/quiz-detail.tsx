    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{quizEntity.timeBegin ? <TextFormat value={quizEntity.timeBegin} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="timeEnd">
              <Translate contentKey="jhipsterClientApp.quiz.timeEnd">Time End</Translate>
            </span>
          </dt>
          <dd>{quizEntity.timeEnd ? <TextFormat value={quizEntity.timeEnd} type="date" format={APP_LOCAL_DATE_FORMAT} /> : null}</dd>
          <dt>
            <span id="duration">
          ...
          <dd>{quizEntity.subjectSubjectName ? quizEntity.subjectSubjectName : ''}</dd>
        </dl>
