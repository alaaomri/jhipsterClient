          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="jhipsterClientApp.quiz.subject">Subject</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {quizList.map((quiz, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{quiz.quizName}</td>
                  <td>{quiz.code}</td>
                  <td>{quiz.timeBegin ? <TextFormat type="date" value={quiz.timeBegin} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{quiz.timeEnd ? <TextFormat type="date" value={quiz.timeEnd} format={APP_LOCAL_DATE_FORMAT} /> : null}</td>
                  <td>{quiz.duration}</td>
                  <td>{quiz.subjectSubjectName ? <Link to={`subject/${quiz.subjectId}`}>{quiz.subjectSubjectName}</Link> : ''}</td>
