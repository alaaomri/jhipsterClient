...
export const CustomerDeleteDialog = (props: ICustomerDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterClientApp.customer.delete.question">
        <Translate contentKey="jhipsterClientApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
