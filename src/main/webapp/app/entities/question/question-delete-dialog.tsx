...
export const QuestionDeleteDialog = (props: IQuestionDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterClientApp.question.delete.question">
        <Translate contentKey="jhipsterClientApp.question.delete.question" interpolate={{ id: questionEntity.id }}>
