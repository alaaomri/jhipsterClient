  ...
  return (
    <div>
      <h2 id="question-heading">
        <Translate contentKey="jhipsterClientApp.question.home.title">Questions</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterClientApp.question.home.createLabel">Create new Question</Translate>
        </Link>
      </h2>
        ...
        {questionList && questionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterClientApp.question.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('question')}>
                  <Translate contentKey="jhipsterClientApp.question.question">Question</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterClientApp.question.home.notFound">No Questions found</Translate>
            </div>
          )
        )}
      </div>
