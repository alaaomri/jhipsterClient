  ...
  return (
    <div>
      <h2 id="answer-heading">
        <Translate contentKey="jhipsterClientApp.answer.home.title">Answers</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="jhipsterClientApp.answer.home.createLabel">Create new Answer</Translate>
        </Link>
      </h2>
        ...
        {answerList && answerList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('code')}>
                  <Translate contentKey="jhipsterClientApp.answer.code">Code</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('answer')}>
                  <Translate contentKey="jhipsterClientApp.answer.answer">Answer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhipsterClientApp.answer.home.notFound">No Answers found</Translate>
            </div>
          )
        )}
      </div>
